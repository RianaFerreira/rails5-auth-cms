...
ComfortableMexicanSofa::AccessControl::AdminAuthentication.username = ENV.fetch("COMFY_USERNAME")
ComfortableMexicanSofa::AccessControl::AdminAuthentication.password = ENV.fetch("COMFY_PSW")
